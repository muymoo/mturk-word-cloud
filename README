...
1. Java AWS SDK Mechanical Turk Setup per these instructions: http://aws.amazon.com/code/Amazon-Mechanical-Turk/695
..* Try running the helloworld example so you know that your good to go
2. Play 2.2.1: http://www.playframework.com/download
..* Just download, unzip, and add the play folder to your PATH
